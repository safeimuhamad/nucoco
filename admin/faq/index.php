...
|--------------------------------------------------------------------------
*/
$total = (int) mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM faqs"))[0];
$active = (int) mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM faqs WHERE status='active'"))[0];
$inactive = (int) mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM faqs WHERE status='inactive'"))[0];
...
*/
if ($search !== '') {
    $count_sql = "SELECT COUNT(*) as total FROM faqs WHERE question LIKE ? OR answer LIKE ?";
...
if ($search !== '') {
    ...
    $sql = "SELECT * FROM faqs ORDER BY display_order ASC, id DESC LIMIT $start, $limit";
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center mb-0 lh-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <span class="text-secondary">FAQ List</span>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-20">
            <div class="d-flex flex-wrap gap-2 gap-xxl-5 align-items-center">
                ...
                <ul class="p-0 mb-0 list-unstyled d-flex align-items-center flex-wrap" style="gap: 20px;">
                    <li class="fs-16">
                        All FAQs <span class="text-primary">(<?= number_format($total) ?>)</span>
                    </li>
                    <li class="fs-16">
            ...
            <a href="create" class="text-primary fs-16 text-decoration-none"> + Add New FAQ</a>
        </div>
                        ...
                        <?php if ($total_data > 0): ?>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars(mb_strimwidth(strip_tags($row['answer']), 0, 100, '...')) ?></td>
