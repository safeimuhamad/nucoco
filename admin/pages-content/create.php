...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($page_id <= 0) {
        ...
        /*
        |--------------------------------------------------------------------------
        | Check duplicate page + language
        |--------------------------------------------------------------------------
        */
        $check_stmt = mysqli_prepare(
            $conn,
            "SELECT id FROM page_contents WHERE page_id = ? AND language_code = ? LIMIT 1"
        );
        ...
        mysqli_stmt_bind_param($check_stmt, "is", $page_id, $language_code);
        ...
        if ($existing_content) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $error = 'Failed to save page content: ' . mysqli_error($conn);
            }
...
<div class="main-content-container overflow-hidden">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
        <h3 class="mb-0">Create Page Content</h3>
    </div>
    ...
    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
        ...
        <form method="POST">
            <div class="row">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary text-white">Save Page Content</button>
