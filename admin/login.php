                            ...
                            <form action="<?= $base_url ?>proses_login" method="POST">
                                ...
                                <div class="mb-20">
                                    ...
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="floatingInput1" name="username" placeholder="Enter email address *">
                                ...
                                <div class="mb-20">
                                    ...
                                    <div class="form-group" id="password-show-hide">
                                        <div class="password-wrapper position-relative password-container">
                                            <input type="password" name="password" class="form-control text-secondary password" placeholder="Enter password *">
                                ...
                                <div class="mb-20">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                                        ...
                                        <a href="<?= admin_url('forgot-password.php') ?>" class="fs-16 text-primary fw-normal text-decoration-none">Forgot Password?</a>
                                    </div>
                                </div>
