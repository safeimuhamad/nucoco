...
*/
if ($search !== '') {
    $count_sql = "SELECT COUNT(*) as total FROM pages WHERE page_name LIKE ? OR slug LIKE ?";
...
if ($search !== '') {
    $sql = "SELECT * FROM pages
            WHERE page_name LIKE ? OR slug LIKE ?
            ORDER BY id DESC
            LIMIT ?, ?";
                ...
                <table class="table align-middle">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="fw-medium">page_name</th>
