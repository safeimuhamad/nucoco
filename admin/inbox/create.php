...
if ($id <= 0) {
    header('Location: /admin/inbox/?error=invalid_id');
    exit;
}
...
if (!$stmt) {
    header('Location: /admin/inbox/?error=prepare_failed');
    exit;
}
...
if (!$inquiry) {
    header('Location: /admin/inbox/?error=not_found');
    exit;
}
...
if ($deleted) {
    header('Location: /admin/inbox/?success=deleted');
    exit;
}

header('Location: /admin/inbox/?error=delete_failed');
exit;
